...
% set PDF metadata
\hypersetup{%
pdftitle={Experimental support for Newton's second law},
pdfauthor={Cole Canada, Stefano D'Agostino, Ethan Fuks, Jason Katz, Ryan Leung, and Edmund Lee},
}
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[RE,RO]{J S\&E \textbf{1}, 11--13 (2024)}
\fancyhead[LO]{Canada et al.}
\fancyhead[LE]{Experimental support for Newton's second law}
\fancyfoot[C]{\thepage}
\fancypagestyle{mytitlepage}{
\fancyhf{}
\fancyhead[C]{Journal of Science \& Engineering \textbf{1}, 11--13 (2024)}
\fancyfoot[C]{\thepage}
}
...
\author{Cole Canada}
\email{Contact author: 426ccanada@frhsd.com}
